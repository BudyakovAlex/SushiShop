...
{
    public class CartToppingItemViewHolder : CardViewHolder<CartToppingItemViewModel>
    {
        private TextView titleTextView;
        private TextView priceTextView;
        private StepperView stepperView;

        public CartToppingItemViewHolder(View view, IMvxAndroidBindingContext context) : base(view, context)
        {
        }
