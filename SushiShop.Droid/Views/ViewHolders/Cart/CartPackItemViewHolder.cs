...
{
    public class CartPackItemViewHolder : CardViewHolder<CartPackItemViewModel>
    {
        private TextView titleTextView;
        private TextView priceTextView;
        private StepperView stepperView;

        public CartPackItemViewHolder(View view, IMvxAndroidBindingContext context) : base(view, context)
        {
        }
