...
{
    public class SimpleMenuActionItemViewHolder : CardViewHolder<MenuActionItemViewModel>
    {
        private TextView titleTextView;
        private View view;

        public SimpleMenuActionItemViewHolder(View view, IMvxAndroidBindingContext context) : base(view, context)
        {
        }
        ...
        public override void BindData()
        {
            ...
            bindingSet.Bind(view).For(v => v.BindClick()).To(v => v.ActionCommand);
        }
    }
}
