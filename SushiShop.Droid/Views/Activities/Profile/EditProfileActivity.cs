...
namespace SushiShop.Droid.Views.Activities.Profile
{
    ...
    public class EditProfileActivity : BaseActivity<EditProfileViewModel>
    {
        ...
        protected override void InitializeViewPoroperties()
        {
            ...
            genderEditText.SetOnClickListener(new ViewOnClickListener(OnGenderEditTextClick));
        }
        ...
        private Task OnGenderEditTextClick(View view)
        {
            if (Mvx.IoCProvider.TryResolve(out IDialog dialog))
            {
