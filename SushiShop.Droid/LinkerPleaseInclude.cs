...
namespace SushiShop.Droid
{
    ...
    public class LinkerPleaseInclude
    {
        public void Include(Button button)
        {
            ...
            button.LongClick += (s, e) => button.ContentDescription = button.ContentDescription + "";
        }
        ...
        public void Include(AppCompatButton btn)
        {
            btn.Click += (o, e) => { };
            btn.LongClick += (s, e) => btn.ContentDescription = btn.ContentDescription + "";
        }
